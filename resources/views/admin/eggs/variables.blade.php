                ...
                <form action="{{ route('admin.nests.egg.variables.edit', ['egg' => $egg->id, 'variable' => $variable->id]) }}" method="POST">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-muted small">これらのルールは標準の <a href="https://laravel.com/docs/5.7/validation#available-validation-rules" target="_blank">Laravel Framework 検証ルール</a>を使用して定義されます。</p>
                        </div>
                    </div>
            ...
            <form action="{{ route('admin.nests.egg.variables', $egg->id) }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <p class="text-muted small">この変数は、起動コマンド内に <code>@{{environment variable value}}</code> と入力してアクセスできます。</p>
                        </div>
                    </div>
                    <div class="form-group">
