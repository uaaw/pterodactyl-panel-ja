                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>サービス内のすべてのオプションを包括する、説明的なカテゴリー名にしてください。</small></p>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">このネストを内部およびAPI経由で識別するために使用される一意IDです。</p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">このサービスオプションの作成者です。<code>support@pterodactyl.io</code> が作成した公式オプションでない限り、質問や問題は作成者に問い合わせてください。</p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">このオプションを使用するすべてのサーバーに、識別目的で割り当てられるUUIDです。</p>
                    </div>
                </div>
            </div>
        </div>
