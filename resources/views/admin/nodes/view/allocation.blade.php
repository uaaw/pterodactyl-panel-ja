...
@section('content-header')
    <h1>{{ $node->name }}<small>このノード上のサーバーで利用できる割り当てを管理します。</small></h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">これらの割り当てにデフォルトエイリアスを設定する場合は、ここに入力してください。</p>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">個別のポートまたはポート範囲を、カンマまたはスペース区切りで入力してください。</p>
                        </div>
                    </div>
                </div>
