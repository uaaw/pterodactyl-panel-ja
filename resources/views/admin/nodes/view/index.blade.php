...
@section('content-header')
    <h1>{{ $node->name }}<small>ノードの概要です。</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <p class="no-margin">ノードの削除は元に戻せない操作で、このノードはパネルから即座に削除されます。続行するには、このノードに関連付けられたサーバーが存在していない必要があります。</p>
                    </div>
                    <div class="box-footer">
                        <form action="{{ route('admin.nodes.view.delete', $node->id) }}" method="POST">
                            {!! csrf_field() !!}
                            {!! method_field('DELETE') !!}
                            <button type="submit" class="btn btn-danger btn-sm pull-right" {{ ($node->servers_count < 1) ?: 'disabled' }}>はい、このノードを削除</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-blue">
                            ...
                            <div class="info-box-content" style="padding: 23px 10px 0;">
                                <span class="info-box-text">サーバー合計</span>
