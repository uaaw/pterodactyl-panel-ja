...
<form action="{{ route('admin.nodes.view.settings', $node->id) }}" method="POST">
    <div class="row">
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-12">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>使用可能な文字: <code>a-zA-Z0-9_.-</code> と <code>[スペース]</code>（1文字以上100文字以下）。</small></p>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <p class="text-muted"><small>デーモンへの接続に使用するドメイン名（例: <code>node.example.com</code>）を入力してください。このノードでSSLを使用しない場合のみ、IPアドレスを使用できます。
                                <a tabindex="0" data-toggle="popover" data-trigger="focus" title="なぜFQDNが必要ですか？" data-content="サーバーとこのノード間の通信を保護するためにSSLを使用します。IPアドレスに対してSSL証明書を生成できないため、FQDNを指定する必要があります。">理由</a>
                            </small></p>
                    </div>
                    <div class="form-group col-xs-12">
                        <label class="form-label"><span class="label label-warning"><i class="fa fa-power-off"></i></span> SSLで通信</label>
                        <div>
                ...
                <div class="box-body row">
                    <div class="col-xs-12">
                        <div class="row">
                            ...
                            <div class="form-group col-xs-6">
                                <label for="memory_overallocate" class="control-label">過剰割り当て</label>
                                <div class="input-group">
                        ...
                        <p class="text-muted small">このノードでサーバーへ割り当て可能なメモリ総量を入力してください。定義済みメモリを超える割り当てを許可する割合も指定できます。</p>
                    </div>
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="form-group col-xs-6">
                            ...
                            <div class="form-group col-xs-6">
                                <label for="disk_overallocate" class="control-label">過剰割り当て</label>
                                <div class="input-group">
                        ...
                        <p class="text-muted small">このノードでサーバーへ割り当て可能なディスク容量の総量を入力してください。設定した制限を超えて許可するディスク容量の割合も指定できます。</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">一般構成</h3>
                </div>
                <div class="box-body row">
                    <div class="form-group col-xs-12">
                        <label for="disk_overallocate" class="control-label">Webアップロード最大ファイルサイズ</label>
                        <div class="input-group">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p class="text-muted"><small>デーモンは独自のSFTP管理コンテナを実行し、メインの物理サーバー上のSSHDプロセスは使用しません。<Strong>物理サーバーのSSHプロセスに割り当てたものと同じポートは使用しないでください。</strong></small></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body row">
                    <div class="form-group col-sm-6">
                        ...
                        <p class="text-muted"><small>デーモンマスターキーをリセットすると、古いキーからのすべてのリクエストが無効になります。このキーは、サーバーの作成や削除を含むデーモン上のすべての機密操作に使用されます。セキュリティのため、このキーを定期的に変更することを推奨します。</small></p>
                    </div>
                </div>
